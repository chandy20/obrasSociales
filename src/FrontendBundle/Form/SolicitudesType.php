...
class SolicitudesType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder
                ...
                ->add('documentoBeneficiarioFinal', null, ['constraints' => $constraint, "label" => "Documento del beneficiario final", 'attr' => array('onkeyup'=> "soloNumeros(this)",'class' => 'form-control ', 'placeholder' => "Documento de identidad")])
