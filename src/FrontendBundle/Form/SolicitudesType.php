...
class SolicitudesType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add( 'idprogramas','idArea', ["label" => "prueba",'required' => true, 'attr'=>array('class' => 'FrontendBundle:id')])
            ...
            ->add('idprogramas', null, ["placeholder"=>"Seleccione", "label" => "Programa", 'required' => true, 'attr'=> array('class'=>'form-control')])
    ...
    {
        $resolver->setDefaults(array('data_class' => 'AppBundle\Entity\Solicitudes'));
    }
